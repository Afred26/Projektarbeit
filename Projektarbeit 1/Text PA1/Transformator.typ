...
- Y: Spulen der OS in Stern-Verdrahtung verschaltet
- (N): Sternpunkt der OS herausgeführt 
- y: Spulen der US in Stern-Verdrahtung verschaltet
- n: Sternpunkt der US herausgeführt
- 0: Phasenverschiebung zwischen OS und US (in Vielfachen von 30°)
- (d): Tertiärspule Dreieck-Verdrahtung verschalten

Für die bereitgestellten 340MVA für die Rechenzentren (170MVA pro Rechenzentrum) wurden 4x 50MVA und 4x 35MVA Trafos verwendet. 
...
== Stufenschalter
Da die Spannung im Netz und die Last der Anlage nicht konstant sind, wird zur Stabilisierung der Spannung ein Stufenschalter an die OS des Transformators eingebaut.
Ein Stufenschalter in einem Transformator dient zur Regelung der Ausgangsspannung.
Er ermöglicht es, die Windungszahl der OS zu verändern, womit das Wicklungsverhältnis NOS/NUS und daraus folgend das Spannungsverhältnis UOS/UUS verändert werden kann.
...
Dazu wird die Spannung auf der US mit einem Spannungsregler überwacht und über verschiedene Grenzwerte und Schaltfunktionen ein optimales Ergebnis für Netzbetreiber und Kunde erreicht.
