...
Every observation is recorded through a common three-level scheme, shown in @tab-classification. The cause level classifies the software defect using the standard classification for software anomalies. #cite(<IEEE_1044>) The effect level expresses the resulting numerical or metrological deviation through @eq-deviation and its uncertainty. #cite(<ASME_VV20>), #cite(<JCGM_100_GUM>) The benchmark level evaluates the consequence against the #acr("CT") adequacy criterion of the #acr("IEC") 61869 series. #cite(<IEC_61869_2>), #cite(<IEC_61869_100>)
